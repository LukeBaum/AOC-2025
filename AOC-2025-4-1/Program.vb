...
Module Program
    Sub Main(args As String())
        ...
        ' Do the math
        ' This is SO MUCH SLOWER than using a multidimensional array, but it's funny
        Dim AccessibleRolls As Integer = 0
        For Y As Integer = 0 To PaperSlots.Count - 1
            For X As Integer = 0 To RollsStrings(0).Length - 1
                If PaperSlots.SlotContainsAccessiblePaperRoll(X, Y) Then AccessibleRolls += 1
            Next
        Next
        Console.WriteLine($"Accessible roll count: {CStr(AccessibleRolls)}")
